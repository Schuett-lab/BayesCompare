...
from .others import (
    ...
    _rsa_acos_np,
    _rsa_acos_torch,
    _rsa_cos_sim_spearman_np,
    _rsa_cos_sim_spearman_torch,
    _rsa_cos_sim_corr_np,
    _rsa_cos_sim_corr_torch,
    _kernel_gulp_np,
    _kernel_gulp_torch,
    _dist_corr_np,
    _dist_corr_torch,
...
REGISTRY = {
    "numpy": {
        ...
        "rsacosspearman": _rsa_cos_sim_spearman_np,
        "rsacossimcorr": _rsa_cos_sim_corr_np,
    ...
    "torch": {
        ...
        "rsacosspearman": _rsa_cos_sim_spearman_torch,
        "rsacossimcorr": _rsa_cos_sim_corr_torch,
